package mono.com.amazon.identity.auth.device.shared;


public class APIListenerImplementor
		...
		com.amazon.identity.auth.device.shared.APIListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Amazon.Identity.Auth.Device.Shared.IAPIListenerImplementor, Xamarin.Amazon.Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", APIListenerImplementor.class, __md_methods);
	}


	public APIListenerImplementor () throws java.lang.Throwable
	{
		super ();
		if (getClass () == APIListenerImplementor.class)
			mono.android.TypeManager.Activate ("Amazon.Identity.Auth.Device.Shared.IAPIListenerImplementor, Xamarin.Amazon.Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

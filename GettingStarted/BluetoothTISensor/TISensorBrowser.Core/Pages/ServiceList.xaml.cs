...
//			List<string> names = hex.Split ('-').ToList<string> ();
//			string resultstring = "";
//			int counter = 0;
//
//			foreach (string name in names) {
//				counter++;
//				int cijfer = int.Parse (name, System.Globalization.NumberStyles.HexNumber);
//				if (counter == 1) {
//					resultstring += "X: " + cijfer.ToString ();
//				} else {
//					if (counter == 2) {
//						resultstring += " Y: " + cijfer.ToString ();
//					} else {
//						resultstring += " Z: " + cijfer.ToString ();
//					}
//				}
//			}
//		}
